    ...
    <body>
        ...
        <div class="panel panel-primary panel-semesterContent">
            ...
            <table border='0' align='center' class="table table-striped">
                ...
                <c:forEach var="content1" items="${content1}">

                    <tr>
                        <td style="text-align: center"><input type="text" class="form-control" value="${content1.national_provider_id}" readonly="true"></td>
                        <td style="text-align: center"><input type="text" class="form-control" value="${content1.avg_stay}" readonly="true"></td>
                        <td style="text-align: center" id="rating"><c:forEach var='i' begin="1" end="${content1.rating}"><img src="../Images/star-full-icon.png" height="15"></c:forEach></td>
                        </tr>   
